...
seagull.config(function ($translateProvider) {
  ...
  $translateProvider.translations('fr-fr', {
    ...
    running_stopped_containers_and: 'conteneurs démarrés ou stoppés, ainsi que',
    ...
    containers_page_display_all_running_and_stopped_docker_containers: 'La page des conteneurs affiche tous les conteneurs docker démarrés ou stoppés.',
    images_page_display_all_docker_images_to_start_stop_and_delete: 'La page des images affiche toutes les images docker à démarrer, stopper ou supprimer.',
    ...
    search_no_docker_image: 'La recherche n\'a retourné aucun résultats',
    description: 'Description',
