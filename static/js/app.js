...
seagull.config(function ($translateProvider) {
  ...
  $translateProvider.translations('de-de', {
    ...
    and_seagull_provides_a_friendly_web_ui_to_monitor_docker: 'und Seagull stellt eine angenehme Web-Oberfläche zum Verwalten von Docker zur Verfügung.',
    github: 'Github',
    go_now: 'Hier lang!',
    ...
    seagull_is_open_source_in_Github_welcome_to_contribution_and_issues: 'Seagull ist Open-Source und auf Github verfügbar. Mitarbeit und Fehlermeldungen sind gerne gesehen.',
    // Containers page
    search: 'Suche',
    filter: 'Filter',
    all: 'Alle',
